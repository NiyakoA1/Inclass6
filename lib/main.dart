...
class CounterDisplay extends StatelessWidget {
  ...
  String getMilestoneMessage(int age) {
    if (age <= 12) return "Luh kid - Enjoy your childhood!";
    if (age <= 19) return "Teenage - Embrace the energy of youth!";
    if (age <= 30) return "Young Adult - ADULTLIFE!";
    if (age <= 50) return "Middle Age - Balance lifestyle thru experience.";
    return "Senior - Enjoy the rest of your life!";
  }
